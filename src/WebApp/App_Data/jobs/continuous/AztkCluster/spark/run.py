...
modelCustomScript = aztk.models.CustomScript("jupyter", "D:/home/site/wwwroot/App_Data/jobs/triggered/AztkCluster/spark/customScripts/jupyter.sh","all-nodes")
...
client.create_user(cluster_id = "predictive-maintenance", username = 'admin', password = 'admin')
