...
If you wish to customize this solution by cloning this GitHub repository, be sure to update the ´´´gitHubBaseUrl´´´ variable accordingly in the [main ARM template](https://github.com/wdecay/AI-PredictiveMaintenance/blob/master/src/ARMTemplates/pdm-arm.json#L60) so that it points to your clone repository.
